...
export const TEXT_PRESETS: TextPreset[] = [
  ...
  },
  {
    ...
    transform: { x: 0.28, y: 0.9 },
    duration: 4,
    animation: { type: 'fadeIn', duration: 0.5 },
  },
  {
    id: 'lower-third-ceremony',
    label: 'ロワーサード（挙式）',
    category: 'lowerThird',
    text: {
  ...
  },
  {
    ...
    duration: 4,
    animation: { type: 'scaleIn', duration: 0.75 },
  },
  {
    id: 'motion-sparkle-vows',
    label: 'MG: スパークル誓い',
    category: 'subtitle',
    text: {
      content: 'I Do',
      ...
      strokeColor: '#2c2c2c',
      strokeWidth: 2,
      shadowColor: 'rgba(255, 230, 180, 0.7)',
      shadowBlur: 20,
      textAlign: 'center',
      verticalAlign: 'center',
      backgroundColor: '',
    ...
    duration: 4,
    animation: { type: 'motionSparkle', duration: 0.8 },
  },
  {
    id: 'motion-ribbon-toast',
    label: 'MG: リボントースト',
    category: 'lowerThird',
    text: {
      content: 'Toast & Cheers',
      fontFamily: 'Noto Serif JP',
      fontSize: 34,
      color: '#f5e6d3',
      strokeColor: '#1a1a1a',
    ...
    transform: { x: 0.32, y: 0.9 },
    duration: 5,
    animation: { type: 'motionRibbon', duration: 0.85 },
  },
  {
    id: 'motion-heartbeat-love',
    label: 'MG: ハートビート',
    category: 'subtitle',
    text: {
      ...
      strokeColor: '#1a1a1a',
      strokeWidth: 0,
      shadowColor: 'rgba(255, 180, 180, 0.55)',
      shadowBlur: 16,
      textAlign: 'center',
      verticalAlign: 'center',
  ...
  },
  {
    ...
    transform: { x: 0.5, y: 0.36 },
    duration: 5,
    animation: { type: 'fadeIn', duration: 0.85 },
  },
  {
    id: 'subtitle-cake-cutting',
    label: 'テロップ（ケーキカット）',
    category: 'subtitle',
    text: {
      content: 'Cake Cutting',
      fontFamily: 'Shippori Mincho',
      fontSize: 52,
      color: '#ffffff',
      strokeColor: '#2c2c2c',
      strokeWidth: 1,
      shadowColor: 'rgba(255, 200, 210, 0.5)',
      shadowBlur: 12,
      textAlign: 'center',
      verticalAlign: 'center',
      backgroundColor: 'rgba(0, 0, 0, 0.28)',
  ...
  {
    id: 'subtitle-ending-roll',
    label: 'テロップ（エンディングロール）',
    category: 'subtitle',
    text: {
      content: 'Cast & Credits',
      fontFamily: 'Noto Sans JP',
      fontSize: 44,
      color: '#e8d5b7',
      strokeColor: '#1a1a1a',
  ...
  {
    id: 'lower-third-family-intro',
    label: 'ロワーサード（親族紹介）',
    category: 'lowerThird',
    text: {
      content: 'Family Introduction',
      fontFamily: 'Shippori Mincho',
      fontSize: 32,
      color: '#f5e6d3',
      strokeColor: '#1a1a1a',
