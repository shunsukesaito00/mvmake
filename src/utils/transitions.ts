...
export const TRANSITION_DEFINITIONS: TransitionDefinition[] = [
  ...
  { type: 'pearlShimmer', label: 'パールシマー', previewAnim: 'tp-in-pearl-shimmer' },
  { type: 'mistFade', label: 'ミストフェード', previewAnim: 'tp-in-mist-fade' },
  { type: 'ribbonCut', label: 'リボンカット', previewAnim: 'tp-in-ribbon-cut' },
