...
最終更新: 2026-07-13（v3.8.0 / Phase G 候補追加: 書き出し信頼性・再生カクつき）
...
| 領域 | 優先 ID | 要点 |
|------|---------|------|
| 書き出し信頼性 | G16, G18 | v3.9.0 でプリフライト・シークタイムアウト完了。メモリは G18 |
| プレビュー | G17, G19, G20 | v3.9.0 で in-flight ガード・UI 8Hz 完了。ネイティブデコードは G19 |
