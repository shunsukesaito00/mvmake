...
- トランジション20種（クロスフェード、ディゾルブ、ブラーディゾルブ、フェード、暖色フェード、ライトリーク、ソフトフォーカス、暖色ディゾルブ、フィルムバーン、ジェントルズーム、花びら舞、ゴールドシマー、ソフトワイプ、ワイプ、スライド、ズーム、アイリス）+ ミニプレビュー
...
- カラールックプリセット（結婚式向け 13 種ルック・ユーザー保存・JSON 共有・Canvas ミニプレビュー（ピクセルグレード整合））
- 映像クリップのフェードイン/アウト
...
- カラールック 13 種・トランジション 20 種（ウェディング向け9種）
