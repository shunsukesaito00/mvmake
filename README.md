...
- トランジション17種（クロスフェード、ディゾルブ、ブラーディゾルブ、フェード、暖色フェード、ライトリーク、ソフトフォーカス、暖色ディゾルブ、フィルムバーン、ジェントルズーム、ワイプ、スライド、ズーム、アイリス）+ ミニプレビュー
...
- カラールックプリセット（結婚式向け 10 種ルック・ユーザー保存・JSON 共有・Canvas ミニプレビュー（ピクセルグレード整合））
- 映像クリップのフェードイン/アウト
...
- カラールック 10 種・トランジション 17 種（ウェディング向け6種）
