...
npm run test:e2e  # E2Eテスト (Playwright、初回は npx playwright install chromium が必要)。全量 1069 件 = basic 809 + editor 260
npm run test:e2e:prod # 公開環境(GitHub Pages)に対するスモークE2E（basic 809 のみ。editor 260 はローカル/CI 全量）
