...
npm run test:e2e  # E2Eテスト (Playwright、初回は npx playwright install chromium が必要)。全量 1072 件 = basic 810 + editor 262
npm run test:e2e:prod # 公開環境(GitHub Pages)に対するスモークE2E（basic 810 のみ。editor 262 はローカル/CI 全量）
