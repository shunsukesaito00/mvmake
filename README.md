...
npm run test:e2e  # E2Eテスト (Playwright、初回は npx playwright install chromium が必要)。全量 1016 件 = basic 790 + editor 226
npm run test:e2e:prod # 公開環境(GitHub Pages)に対するスモークE2E（basic 790 のみ。editor 226 はローカル/CI 全量）
