...
npm run test:e2e  # E2Eテスト (Playwright、初回は npx playwright install chromium が必要)。全量 1061 件 = basic 806 + editor 255
npm run test:e2e:prod # 公開環境(GitHub Pages)に対するスモークE2E（basic 806 のみ。editor 255 はローカル/CI 全量）
