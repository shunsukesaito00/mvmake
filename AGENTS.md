...
| `e2e/` | Playwright E2E テスト（`npm run test:e2e` 全量 1016 件 = `basic` 790 + `editor` 226。本番スモーク `test:e2e:prod` は **basic 790 のみ**） |
...
| `docs/PROD_SMOKE_AUDIT.md` | 本番スモーク E2E（`test:e2e:prod`・790 シナリオ）（v3.0.2） |
