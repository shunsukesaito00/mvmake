...
| `e2e/` | Playwright E2E テスト（`npm run test:e2e` 全量 1022 件 = `basic` 796 + `editor` 226。本番スモーク `test:e2e:prod` は **basic 796 のみ**） |
...
| `docs/PROD_SMOKE_AUDIT.md` | 本番スモーク E2E（`test:e2e:prod`・796 シナリオ）（v3.0.3） |
