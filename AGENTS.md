...
| `e2e/` | Playwright E2E テスト（`npm run test:e2e` 全量 1012 件 = `basic` 786 + `editor` 226。本番スモーク `test:e2e:prod` は **basic 786 のみ**） |
...
| `docs/PROD_SMOKE_AUDIT.md` | 本番スモーク E2E（`test:e2e:prod`・786 シナリオ）（v3.0.1） |
